...
class Token:
    ...
    Attributes:
        ...
        symbols: Para una clase ``[...]``, los simbolos que acepta, ordenados.
            En una clase, ``value`` guarda el texto original, p. ej. ``[a-z0-9]``.
    """
    ...
    def is_operand(self) -> bool:
        """Un simbolo del alfabeto, una clase de caracteres o epsilon."""
        return self.type in (TokenType.SYMBOL, TokenType.CLASS, TokenType.EPSILON)
