...
from .constants import EPSILON_ASCII, EPSILON_INPUT, EPSILON_LABEL
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            f"Epsilon se escribe '{EPSILON_INPUT}' o '{EPSILON_ASCII}' y se muestra como "
            f"'{EPSILON_LABEL}'; en el archivo de cadenas '{EPSILON_INPUT}' o "
            f"'{EPSILON_ASCII}' es la cadena vacia.\n"
            "El punto '.' es un simbolo literal; la concatenacion es implicita.\n"
            "Se admiten clases de caracteres como [a-zA-Z0-9._-].\n"
